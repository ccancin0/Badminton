...
class ActorsControllerTest < ActionDispatch::IntegrationTest
  ...
  #test "should create actor" do
   # assert_difference('Actor.count') do
    #  post actors_url, params: { actor: { age: @actor.age, gender: @actor.gender, homepage: @actor.homepage, name: @actor.name } }
    #end
  ...
  #test "should update actor" do
    #patch actor_url(@actor), params: { actor: { age: @actor.age, gender: @actor.gender, homepage: @actor.homepage, name: @actor.name } }
