...
class ProducersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create producer" do
    assert_difference('Producer.count') do
      post producers_url, params: { producer: { activation_date: @producer.activation_date, greeting: @producer.greeting, mission_statement: @producer.mission_statement, name: @producer.name } }
    end
  ...
  test "should update producer" do
    patch producer_url(@producer), params: { producer: { activation_date: @producer.activation_date, greeting: @producer.greeting, mission_statement: @producer.mission_statement, name: @producer.name } }
